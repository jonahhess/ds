...
import (
	...
	"myapp/internal/auth"
	about "myapp/internal/views/pages/about"
	"myapp/internal/views/pages/courses"
	home "myapp/internal/views/pages/home"
	"myapp/internal/views/pages/login"
	"myapp/internal/views/pages/myCourses"
	"myapp/internal/views/pages/notFound"
	"myapp/internal/views/pages/review"
	"myapp/internal/views/pages/signup"
	"myapp/internal/views/pages/study"
