...
func GetUserLinks(user types.UserType) []types.Link {
...
func Navbar(user types.UserType) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, l := range GetUserLinks(user) {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/components/navbar/navbar.templ`, Line: 26, Col: 42}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/components/navbar/navbar.templ`, Line: 26, Col: 54}
			}
